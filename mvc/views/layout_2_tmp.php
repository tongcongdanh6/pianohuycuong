...
<body class="university-lp">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav mr-auto smooth-scroll">
            ...
            <li class="nav-item">
              <a class="nav-link waves-effect waves-light" href="#info" data-offset="100">Info</a>
            </li>
            <li class="nav-item">
              <a class="nav-link waves-effect waves-light" href="#courses" data-offset="100">Courses</a>
            </li>
            <li class="nav-item">
              <a class="nav-link waves-effect waves-light" href="#events" data-offset="100">Events</a>
            </li>
            <li class="nav-item">
        ...
        <!-- Intro Section -->
        <div id="home" class="view jarallax" data-jarallax='{"speed": 0.2}' style="background-image: url('../public/images/mdb/67.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
                ...
                <div class="container h-100 d-flex justify-content-center align-items-center">
                    <div class="row smooth-scroll">
                        <div class="col-md-12 white-text text-center">
                            ...
                            <a href="#courses" data-offset="100" class="btn btn-warning wow fadeInRight" data-wow-delay="0.2s">Courses</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <main>
            ...
            <section id="about" class="mt-4 mb-2">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-12 mb-5 pb-4 wow fadeIn" data-wow-delay="0.4s">
                        ...
                        <!--Image-->
                        <img src="../public/images/mdb/img%20%289%29.jpg" class="img-fluid z-depth-1 rounded" alt="My photo">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-5 col-md-12">
                                        ...
                                        <div class="view overlay z-depth-1 mb-2">
                                            <img src="../public/images/mdb/54.jpg" class="rounded img-fluid" alt="sample image">
                                        </div>
                                    </div>
                                    <!--First column-->
                            ...
                            <div class="tab-pane fade" id="panel32" role="tabpanel">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-5 col-md-12">
                                        ...
                                        <!--Featured image-->
                                        <div class="view overlay z-depth-1 mb-2">
                                            <img src="../public/images/mdb/img%20%2840%29.jpg" class="rounded img-fluid" alt="sample image">
                                        </div>
                                    </div>
                                    <!--First column-->
                            ...
                            <div class="tab-pane fade" id="panel33" role="tabpanel">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-5 col-md-12">
                                        ...
                                        <!--Featured image-->
                                        <div class="view overlay z-depth-1 mb-2">
                                            <img src="../public/images/mdb/img%20%2841%29.jpg" class="rounded img-fluid" alt="sample image">
                                        </div>
                                    </div>
                                    <!--First column-->
                            ...
                            <div class="tab-pane fade" id="panel34" role="tabpanel">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-5 col-md-12">
                                        ...
                                        <!--Featured image-->
                                        <div class="view overlay z-depth-1 mb-2">
                                            <img src="../public/images/mdb/img%20%2842%29.jpg" class="rounded img-fluid" alt="sample image">
                                        </div>
                                    </div>
                                    <!--First column-->
        ...
        <!--Streak-->
        <div class="streak streak-photo streak-md" style="background-image: url('../public/images/mdb/img%20%287%29.jpg');">
                    ...
                    <div class="row mb-5 pb-3">
                        ...
                        <div class="col-lg-3 col-md-6 mb-4 wow fadeIn" data-wow-delay="0.4s">
                            ...
                            <div class="card">
                                ...
                                <div class="view overlay">
                                    <img src="../public/images/mdb/51.jpg" class="card-img-top" alt="">
                                    <a>
                        ...
                        <div class="col-lg-3 col-md-6 mb-4 wow fadeIn" data-wow-delay="0.4s">
                            ...
                            <div class="card">
                                <!--Card image-->
                                <div class="view overlay">
                                    <img src="../public/images/mdb/40.jpg" class="card-img-top" alt="">
                                    <a>
                                        <div class="mask rgba-white-slight"></div>
                                    </a>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6 mb-4 wow fadeIn" data-wow-delay="0.4s">
                            ...
                            <div class="card">
                                <!--Card image-->
                                <div class="view overlay">
                                    <img src="../public/images/mdb/56.jpg" class="card-img-top" alt="">
                                    <a>
                                        <div class="mask rgba-white-slight"></div>
                                    </a>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6 mb-4 wow fadeIn" data-wow-delay="0.4s">
                            ...
                            <div class="card">
                                <!--Card image-->
                                <div class="view overlay">
                                    <img src="../public/images/mdb/57.jpg" class="card-img-top" alt="">
                                    <a>
                                        <div class="mask rgba-white-slight"></div>
                                    </a>
                                </div>
                            ...
                            <div class="carousel-item active">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="testimonial">
                                        ...
                                        <div class="avatar mx-auto mb-4">
                                            <img src="../public/images/mdb/img%20(26).jpg" class="rounded-circle img-fluid">
                                        </div>
                                        <!--Content-->
                                ...
                                <div class="col-md-4 clearfix d-none d-sm-block">
                                    <div class="testimonial">
                                        <!--Avatar-->
                                        <div class="avatar mx-auto mb-4">
                                            <img src="../public/images/mdb/img%20(27).jpg" class="rounded-circle img-fluid">
                                        </div>
                                        <!--Content-->
                                ...
                                <div class="col-md-4 clearfix d-none d-sm-block">
                                    <div class="testimonial">
                                        <!--Avatar-->
                                        <div class="avatar mx-auto mb-4">
                                            <img src="../public/images/mdb/img%20(31).jpg" class="rounded-circle img-fluid">
                                        </div>
                                        <!--Content-->
                            ...
                            <div class="carousel-item">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="testimonial">
                                        <!--Avatar-->
                                        <div class="avatar mx-auto mb-4">
                                            <img src="../public/images/mdb/img%20(4).jpg" class="rounded-circle img-fluid">
                                        </div>
                                        <!--Content-->
                                ...
                                <div class="col-md-4 clearfix d-none d-sm-block">
                                    <div class="testimonial">
                                        <!--Avatar-->
                                        <div class="avatar mx-auto mb-4">
                                            <img src="../public/images/mdb/img%20(6).jpg" class="rounded-circle img-fluid">
                                        </div>
                                        <!--Content-->
                                ...
                                <div class="col-md-4 clearfix d-none d-sm-block">
                                    <div class="testimonial">
                                        <!--Avatar-->
                                        <div class="avatar mx-auto mb-4">
                                            <img src="../public/images/mdb/img%20(7).jpg" class="rounded-circle img-fluid">
                                        </div>
                                        <!--Content-->
                            ...
                            <div class="carousel-item">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="testimonial">
                                        <!--Avatar-->
                                        <div class="avatar mx-auto mb-4">
                                            <img src="../public/images/mdb/img%20(8).jpg" class="rounded-circle img-fluid">
                                        </div>
                                        <!--Content-->
                                ...
                                <div class="col-md-4 clearfix d-none d-sm-block">
                                    <div class="testimonial">
                                        <!--Avatar-->
                                        <div class="avatar mx-auto mb-4">
                                            <img src="../public/images/mdb/img%20(10).jpg" class="rounded-circle img-fluid">
                                        </div>
                                        <!--Content-->
                                ...
                                <div class="col-md-4 clearfix d-none d-sm-block">
                                    <div class="testimonial">
                                        <!--Avatar-->
                                        <div class="avatar mx-auto mb-4">
                                            <img src="../public/images/mdb/img%20(9).jpg" class="rounded-circle img-fluid">
                                        </div>
                                        <!--Content-->
