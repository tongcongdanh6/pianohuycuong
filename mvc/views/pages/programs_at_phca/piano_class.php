    ...
    <section class="mt-5 mb-5 py-3 wow fadeIn" data-wow-delay="0.2s" style="visibility: visible; animation-name: fadeIn; animation-delay: 0.2s;">
      ...
      <div class="row pt-2 mt-lg-5">
        ...
        <div class="col-lg-6 col-md-12 mb-3 wow fadeIn" data-wow-delay="0.4s" style="visibility: visible; animation-name: fadeIn; animation-delay: 0.4s;">
          <!-- Image -->
          <img src="<?= $_GLOBAL["publicURL"] ?>/public/images/programs_at_phca/piano-class-2.jpg" class="img-fluid z-depth-4">
        ...
        <div class="col-lg-6 ml-auto col-md-12 px-5 py-5 wow fadeIn" data-wow-delay="0.4s" style="visibility: visible; animation-name: fadeIn; animation-delay: 0.4s;">
          ...
          <h2 class="mb-5 title font-weight-bold wow fadeIn" data-wow-delay="0.2s" style="visibility: visible; animation-name: fadeIn; animation-delay: 0.2s;">
            <strong class="text-uppercase"><?= $data["langData"]["piano_class_header_text"] ?></strong>
          </h2>

          <!-- Description -->
          <p align="justify"><?= $data["langData"]["piano_class_content_text_1"] ?></p>
        </div>
        <!-- Grid column -->
    ...
    <div class="row wow fadeIn" data-wow-delay="0.2s" style="visibility: visible; animation-name: fadeIn; animation-delay: 0.2s;">
      ...
      <div class="col-lg-6 col-md-6">
        <p class="text-justify">
          ...
          <?= $data["langData"]["piano_class_content_text_2"] ?>
        </p>
        <p class="text-justify">
          <i class="fas fa-long-arrow-alt-right orange-text mr-2" aria-hidden="true"></i> 
          <?= $data["langData"]["piano_class_content_text_3"] ?>
        </p>
        <p class="text-justify">
          <i class="fas fa-long-arrow-alt-right orange-text mr-2" aria-hidden="true"></i> 
          <?= $data["langData"]["piano_class_content_text_4"] ?>
        </p>
        <p class="text-justify">
          <i class="fas fa-long-arrow-alt-right orange-text mr-2" aria-hidden="true"></i> 
          <?= $data["langData"]["piano_class_content_text_5"] ?>
        </p>
        <p class="text-justify">
          <i class="fas fa-long-arrow-alt-right orange-text mr-2" aria-hidden="true"></i> 
          <?= $data["langData"]["piano_class_content_text_6"] ?>
        </p>
      </div>
    </div>    
    ...
    <div class="row pt-5 wow fadeIn" data-wow-delay="0.2s" style="visibility: visible; animation-name: fadeIn; animation-delay: 0.2s;">
      ...
      <div class="col-lg-6 col-md-6">
        <div>
          ...
          <p class="text-justify">
            <i class="fas fa-long-arrow-alt-right orange-text mr-2" aria-hidden="true"></i>
            <?= $data["langData"]["piano_class_content_text_7"] ?>
          </p>
          <p class="text-justify">
            <i class="fas fa-long-arrow-alt-right orange-text mr-2" aria-hidden="true"></i>
            <?= $data["langData"]["piano_class_content_text_8"] ?>
          </p>          
          <p class="text-justify">
            <i class="fas fa-long-arrow-alt-right orange-text mr-2" aria-hidden="true"></i>
            <?= $data["langData"]["piano_class_content_text_9"] ?>
          </p>          
          <p class="text-justify">
            <i class="fas fa-long-arrow-alt-right orange-text mr-2" aria-hidden="true"></i>
            <?= $data["langData"]["piano_class_content_text_10"] ?>
          </p> 
        </div>
        ...
        <div class="pt-2">
          ...
          <p class="text-justify">
            <i class="fas fa-long-arrow-alt-right orange-text mr-2" aria-hidden="true"></i> 
            <?= $data["langData"]["piano_class_content_text_11"] ?>
          </p>        
          <p class="text-justify">
            <i class="fas fa-long-arrow-alt-right orange-text mr-2" aria-hidden="true"></i> 
            <?= $data["langData"]["piano_class_content_text_12"] ?>
          </p>
          <p class="text-justify">
            <i class="fas fa-long-arrow-alt-right orange-text mr-2" aria-hidden="true"></i> 
            <?= $data["langData"]["piano_class_content_text_13"] ?>
          </p>
          <p class="text-justify">
            <i class="fas fa-long-arrow-alt-right orange-text mr-2" aria-hidden="true"></i> 
            <?= $data["langData"]["piano_class_content_text_14"] ?>
          </p>
        </div>
        ...
        <div class="pt-2">
          ...
          <p class="text-justify">
            <i class="fas fa-long-arrow-alt-right orange-text mr-2" aria-hidden="true"></i> 
            <?= $data["langData"]["piano_class_content_text_15"] ?>
          </p>       
          <p class="text-justify">
            <i class="fas fa-long-arrow-alt-right orange-text mr-2" aria-hidden="true"></i> 
            <?= $data["langData"]["piano_class_content_text_16"] ?>
          </p>        
          <p class="text-justify">
            <i class="fas fa-long-arrow-alt-right orange-text mr-2" aria-hidden="true"></i> 
            <?= $data["langData"]["piano_class_content_text_17"] ?>
          </p>
          <p class="text-justify">
            <i class="fas fa-long-arrow-alt-right orange-text mr-2" aria-hidden="true"></i> 
            <?= $data["langData"]["piano_class_content_text_18"] ?>
          </p>
          <p class="text-justify note note-success">
            <?= $data["langData"]["piano_class_content_text_19"] ?>
          </p>
        </div>
